  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        <div className="glass-panel w-full max-w-3xl p-6 rounded-2xl border border-[#1E2748]/15 bg-[#FFFFFF] shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto text-xs text-[#53627C]">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#1E2748]/10">
            <div className="flex items-center space-x-3">
              <div className="p-3 bg-[#FFFFFF] text-[#1E2748] rounded-2xl border border-[#1E2748]/15 shadow">
            ...
            <div className="flex items-center space-x-2 self-end sm:self-auto">
              ...
              <button
                onClick={onClose}
                className="p-1.5 bg-[#FFFFFF] text-[#53627C] hover:text-white rounded-xl border border-[#1E2748]/15 transition"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className={`p-4 rounded-2xl border transition-all ${
            isIdUnlocked
              ...
              : 'bg-[#FFFFFF]/90 border-amber-500/40 shadow-lg'
          }`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="glass-panel p-4 rounded-2xl border border-[#1E2748]/15 bg-[#FFFFFF]/60 space-y-3">
              <h3 className="text-xs font-bold text-[#1E2748] uppercase tracking-wider flex items-center space-x-2 border-b border-[#1E2748]/10 pb-2">
                <User className="w-4 h-4 text-[#1E2748]" />
                <span>Customer Profile & Contact Information</span>
              </h3>

              <div className="space-y-2 text-xs">
                <div className="flex justify-between py-1 border-b border-[#1E2748]/20/10">
          ...
          <div className="glass-panel p-4 rounded-2xl border border-[#1E2748]/15 bg-[#FFFFFF]/60 space-y-3">
            ...
            <p className="text-xs text-[#1E2748] leading-relaxed font-mono bg-[#FFFFFF] p-3 rounded-xl border border-[#1E2748]/10">
          ...
          {/* Action Footer */}
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-[#1E2748]/10">
            ...
            <div className="flex items-center space-x-2">
              {isCfoOrAdmin && (
                <>
                  <button
                    ...
                    className="px-3.5 py-2 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] border border-[#1E2748]/15 rounded-xl font-bold transition flex items-center space-x-1.5 shadow"
                  >
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] font-extrabold rounded-xl shadow transition"
              >
                Close Detailed View
              </button>
            </div>
