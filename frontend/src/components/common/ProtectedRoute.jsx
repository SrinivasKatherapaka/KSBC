...
export const ProtectedRoute = ({ children, roles = [] }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FAF7E6] flex items-center justify-center text-[#1E2748]">
  ...
  if (!isAllowed) {
    return (
      <div className="min-h-screen bg-[#FAF7E6] flex items-center justify-center p-4">
        <div className="max-w-md w-full glass-panel p-8 rounded-3xl border border-red-500/30 bg-[#FFFFFF] shadow-2xl text-center space-y-5">
          ...
          <div className="p-3 bg-[#FAF7E6] rounded-xl border border-[#1E2748]/15 text-[11px] text-[#53627C] flex items-center justify-center space-x-2">
          ...
          <Link
            to="/dashboard"
            className="w-full py-3 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] text-xs font-black rounded-xl shadow-lg transition flex items-center justify-center space-x-2"
          >
