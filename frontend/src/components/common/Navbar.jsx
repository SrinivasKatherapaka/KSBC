...
export const Navbar = () => {
  ...
  return (
    <>
      <header className="h-16 border-b border-[#1E2748]/15 px-6 flex items-center justify-between sticky top-0 z-20 bg-[#F3EEDC]/95 backdrop-blur-xl shadow-sm text-[#1E2748]">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative group">
            <button className="flex items-center space-x-2 bg-[#EBE4CD] hover:bg-[#E3DCBF] px-3.5 py-1.5 rounded-xl border border-[#1E2748]/20 text-xs font-bold text-[#1E2748] shadow-sm transition">
              <KeyRound className="w-3.5 h-3.5 text-[#1E2748]" />
              <span>Shift Clearance Role</span>
            </button>

            <div className="absolute right-0 mt-1 w-60 p-2 rounded-2xl border border-[#1E2748]/20 shadow-2xl hidden group-hover:block z-50 space-y-1 bg-[#F3EEDC] backdrop-blur-xl">
          ...
          >
            <LogOut className="w-3.5 h-3.5 text-[#FAF7E6]" />
