...
export const LoanApplicationModal = ({ isOpen, onClose, customers = [], onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="glass-panel w-full max-w-xl p-6 rounded-2xl border border-[#1E2748]/15 shadow-2xl relative bg-[#FFFFFF]">
        <div className="flex items-center justify-between pb-4 border-b border-[#1E2748]/10 mb-5">
        ...
        {error && (
          <div className="p-3 mb-4 bg-[#FFFFFF] border border-red-500/40 rounded-xl text-xs text-[#1E2748]">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4 flex items-center justify-end space-x-3 border-t border-[#1E2748]/15">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-5 py-2.5 bg-[#1E2748] hover:bg-[#141C33] text-white text-xs font-bold rounded-xl shadow-lg shadow-[#FFFFFF]/30 transition disabled:opacity-50 border border-[#1E2748]/20"
            >
