...
=====================================================`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fadeIn">
      <div className="glass-panel w-full max-w-4xl p-6 rounded-3xl border border-[#1E2748]/15 bg-[#FFFFFF] shadow-2xl space-y-5 max-h-[92vh] overflow-y-auto text-xs text-[#53627C]">
        
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#1E2748]/10">
          <div className="flex items-center space-x-3">
            <div className="p-3 bg-[#FFFFFF] text-[#1E2748] rounded-2xl border border-[#1E2748]/15 shadow-md">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="font-mono text-xs px-2 py-0.5 rounded bg-[#FFFFFF] text-[#1E2748] font-bold border border-[#1E2748]/15">
                  Ref #{loanIdStr}
                </span>
              </div>
          ...
          <div className="flex items-center space-x-2 self-end sm:self-auto">
            ...
            <button
              onClick={onClose}
              className="p-1.5 bg-[#FFFFFF] text-[#53627C] hover:text-white rounded-xl border border-[#1E2748]/15 transition cursor-pointer"
              title="Close Modal"
            >
              <X className="w-5 h-5" />
            </button>
        ...
        {/* Feedback Message */}
        {feedbackMsg && (
          <div className="p-3 bg-[#FFFFFF] border border-[#1E2748]/15 rounded-xl text-xs font-bold text-[#1E2748] flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3.5 bg-[#FFFFFF]/90 rounded-2xl border border-[#1E2748]/15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="p-4 bg-[#FFFFFF]/70 rounded-2xl border border-[#1E2748]/15 space-y-3">
            <div className="flex items-center justify-between pb-2 border-b border-[#1E2748]/10">
              ...
              <span className="px-2 py-0.5 rounded text-[9px] font-bold uppercase bg-[#FFFFFF] text-[#1E2748] border border-[#1E2748]/15">
                {category.replace('_', ' ')}
              </span>
            </div>
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="pt-2 border-t border-[#1E2748]/20/15">
                <span className="text-[10px] text-[#53627C] block mb-1 font-bold uppercase">Decision Notes / Status Rationale:</span>
                <p className="text-[11px] italic text-[#1E2748] bg-[#FFFFFF] p-2 rounded-xl border border-[#1E2748]/10">
          ...
          <div className="p-4 bg-[#FFFFFF]/70 rounded-2xl border border-[#1E2748]/15 space-y-3">
            <div className="flex items-center justify-between pb-2 border-b border-[#1E2748]/10">
              ...
              <button
                ...
                className="px-2 py-0.5 bg-[#1E2748]/10 hover:bg-[#1E2748]/30 text-[#1E2748] rounded text-[10px] font-bold border border-[#1E2748]/15 flex items-center space-x-1 transition cursor-pointer"
              >
            ...
            <div className="p-3 bg-[#FFFFFF] rounded-xl border border-[#1E2748]/15 flex items-center justify-between">
              <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="p-2 bg-[#FFFFFF]/80 rounded-lg border border-[#1E2748]/10">
            ...
            {aiData.summaryAdvisory && (
              <p className="text-[10px] italic text-[#53627C] bg-[#FFFFFF] p-2 rounded-lg border border-[#1E2748]/20/15">
                🤖 "{aiData.summaryAdvisory}"
              </p>
            )}
          </div>
        ...
        {activeActionPrompt && (
          <div className="p-4 bg-[#FFFFFF] rounded-2xl border border-[#1E2748]/20 space-y-3 animate-fadeIn shadow-xl">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full glass-input bg-[#FAF7E6] text-white rounded-xl p-2.5 text-xs"
              />
            </div>
        ...
        <div className="pt-4 border-t border-[#1E2748]/10 flex flex-wrap items-center justify-between gap-3">
          {/* Left Utilities */}
          <div className="flex items-center space-x-2">
            <button
              type="button"
              onClick={handleExportSlip}
              className="px-3 py-2 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] rounded-xl border border-[#1E2748]/15 font-bold transition flex items-center space-x-1.5 cursor-pointer text-xs"
            >
