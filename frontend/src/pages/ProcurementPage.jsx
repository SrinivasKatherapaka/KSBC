      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            {canManageProcurement && (
              <button
                ...
                className="px-4 py-2.5 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] text-xs font-black rounded-xl shadow-lg transition flex items-center space-x-2 self-start md:self-auto"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 bg-[#FFFFFF]/80 rounded-2xl border border-[#1E2748]/20 space-y-1 shadow-lg">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="glass-panel p-5 rounded-2xl border border-[#1E2748]/15 space-y-4 bg-[#FFFFFF]/60 shadow-xl">
                ...
                <div className="space-y-3 text-xs max-h-[500px] overflow-y-auto pr-1">
                  {vendors.map((v) => (
                    <div key={v.id} className="p-3.5 bg-[#FFFFFF] rounded-xl border border-[#1E2748]/10 space-y-1 hover:border-[#1E2748]/20 transition">
              ...
              <div className="lg:col-span-2 glass-panel p-6 rounded-2xl border border-[#1E2748]/15 space-y-4 bg-[#FFFFFF]/60 shadow-xl">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#1E2748]/10 pb-3">
                  <h3 className="text-sm font-bold text-[#1E2748] flex items-center space-x-2">
                  ...
                  {/* Filter Tabs */}
                  <div className="flex items-center space-x-1 bg-[#FFFFFF] p-1 rounded-xl border border-[#1E2748]/15 text-[11px]">
                    {[
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-[#1E2748]/15">
                        {filteredOrders.map((po) => {
                          ...
                          return (
                            <tr key={po.id} className="hover:bg-[#FFFFFF]/40 transition">
                              ...
                              <td className="py-3.5 px-3 text-center">
                                {isPaid ? (
                                  ...
                                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase bg-[#1E2748]/30 text-[#1E2748] border border-[#1E2748]/20 animate-pulse">
                                    PAYMENT DUE
                                  </span>
                                ) : (
                              ...
                              <td className="py-3.5 px-3 text-center">
                                {isPaid ? (
                                  ...
                                  <button
                                    ...
                                    className="px-2.5 py-1 bg-[#1E2748] hover:bg-[#141C33]  text-[#FAF7E6] font-black text-[10px] rounded-lg shadow transition disabled:opacity-50"
                                  >
