    ...
    <div className="flex min-h-screen bg-[#FAF7E6] text-[#53627C]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="px-4 py-2.5 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] text-xs font-black rounded-xl shadow-lg transition flex items-center space-x-2"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] text-xs font-bold rounded-xl border border-[#1E2748]/15 transition flex items-center space-x-2 shadow-lg"
              >
          ...
          <div className={`glass-panel p-4 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs ${
            canCreateAccount
              ? 'border-[#58b388]/40 bg-[#FFFFFF]/80 text-[#58b388]'
              : 'border-amber-500/40 bg-[#FFFFFF]/80 text-amber-300'
          }`}>
          ...
          <div className="glass-panel p-3.5 rounded-2xl border border-[#1E2748]/15 flex flex-col md:flex-row md:items-center justify-between gap-3 bg-[#FFFFFF]/60">
              ...
              {[
                ...
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl font-semibold transition text-xs flex-shrink-0 ${
                    categoryFilter === f.id
                      ? 'bg-[#FFFFFF] text-[#1E2748] border border-[#1E2748]/20 shadow-md font-bold'
                      : 'bg-[#FFFFFF]/60 text-[#53627C] hover:text-[#1E2748] border border-[#1E2748]/10'
                  }`}
                >
                  {f.label}
                </button>
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full glass-input bg-[#FFFFFF] border border-[#1E2748]/15 text-xs rounded-xl p-2 pl-9 text-[#1E2748] focus:outline-none focus:ring-2 focus:ring-[#1E2748]"
              />
            </div>
          </div>
          ...
          {selectedIds.length > 0 && (
            <div className="p-3.5 bg-[#FFFFFF] border border-[#1E2748]/15 rounded-2xl flex items-center justify-between text-xs text-[#1E2748] shadow-xl">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-[#FFFFFF] text-[#53627C] hover:text-white rounded-xl font-semibold"
                >
                  Deselect All
                </button>
              </div>
          ...
          {loading ? (
            ...
            <div className="glass-panel rounded-2xl border border-[#1E2748]/15 overflow-hidden p-5 space-y-4 bg-[#FFFFFF]/60 shadow-xl">
                    ...
                    {filteredAccounts.map((c) => {
                      ...
                      return (
                        <tr
                          ...
                          className={`transition cursor-pointer ${isSelected ? 'bg-[#FFFFFF]/90' : 'hover:bg-[#FFFFFF]/70 hover:shadow-inner'}`}
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4">
                            ...
                            <span className={`inline-flex items-center px-2 py-0.5 rounded text-[9px] font-bold border uppercase mt-1 ${
                              isHnwi
                                ...
                                : isCorporate
                                ? 'bg-[#1E2748]/10 text-[#1E2748] border-[#1E2748]/15'
                                : 'bg-[#FFFFFF] text-purple-300 border-purple-500/30'
                            }`}>
                          ...
                          <td className="py-3.5 px-4 text-center" onClick={(e) => e.stopPropagation()}>
                            <div className="flex items-center justify-center space-x-1.5">
                              <button
                                onClick={() => { setViewingCustomer(c); navigate(`/accounts/${c.id}`); }}
                                className="px-2.5 py-1 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] hover:text-white border border-[#1E2748]/15 rounded-lg text-[10px] font-bold transition flex items-center space-x-1 shadow"
                              ...
                              <button
                                ...
                                className="px-2.5 py-1 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] border border-[#1E2748]/15 rounded-lg text-[10px] font-bold transition flex items-center space-x-1 shadow"
      ...
      {isCreateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="glass-panel w-full max-w-2xl p-6 rounded-2xl border border-[#1E2748]/15 bg-[#FFFFFF] shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
      ...
      {accessDeniedMsg && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="glass-panel w-full max-w-md p-6 rounded-2xl border border-amber-500/40 bg-[#FFFFFF] shadow-2xl space-y-4">
            <div className="flex items-center space-x-3 text-amber-400 border-b border-amber-500/20 pb-3">
              <div className="p-2 bg-[#FFFFFF] rounded-xl border border-amber-500/40">
            ...
            <div className="p-3 bg-[#FFFFFF] rounded-xl border border-[#1E2748]/15 text-xs space-y-1">
            ...
            <div className="pt-2 flex justify-end space-x-2">
              <button
                ...
                className="px-4 py-2 bg-[#FFFFFF] hover:bg-[#FFFFFF] text-[#1E2748] font-bold rounded-xl text-xs border border-[#1E2748]/15"
              >
                Switch Credentials Persona
              </button>
              <button
                onClick={() => setAccessDeniedMsg('')}
                className="px-4 py-2 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] font-bold rounded-xl text-xs"
              >
                Dismiss
              </button>
            </div>
