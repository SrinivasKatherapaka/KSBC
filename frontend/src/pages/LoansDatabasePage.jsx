        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-extrabold text-[#FAF7E6] font-heading flex items-center space-x-2">
                <Database className="w-6 h-6 text-[#FAF7E6]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-[#15203B]/85 text-[#FAF7E6]/60 rounded-2xl border border-[#DFBD84]/15 space-y-1">
              <span className="text-[10px] font-bold text-[#FAF7E6] uppercase block">TOTAL PORTFOLIO VOLUME</span>
              <span className="text-xl font-black text-[#FAF7E6] font-mono">
                ${totalPrincipalSum.toLocaleString('en-US', { minimumFractionDigits: 2 })}
              </span>
              <span className="text-[10px] text-[#94A3B8] block font-medium">{loans.length} Total Master Database Records</span>
            </div>

            <div className="p-4 bg-[#15203B]/85 text-[#FAF7E6]/80 rounded-2xl border border-[#58b388]/50 space-y-1 shadow-lg">
            ...
            <div className="p-4 bg-[#15203B]/85 text-[#FAF7E6]/60 rounded-2xl border border-[#DFBD84]/15 space-y-1">
              <span className="text-[10px] font-bold text-[#FAF7E6] uppercase block">APPROVED AWAITING DISBURSEMENT</span>
            ...
            <div className="p-4 bg-[#15203B]/85 text-[#FAF7E6]/60 rounded-2xl border border-[#DFBD84]/15 space-y-1">
              <span className="text-[10px] font-bold text-[#FAF7E6] uppercase block">PENDING PIPELINE VOLUME</span>
              <span className="text-xl font-black text-[#FAF7E6] font-mono">
                ${totalPendingSum.toLocaleString('en-US', { minimumFractionDigits: 2 })}
              </span>
              <span className="text-[10px] text-[#FAF7E6]/80 block font-bold">In Underwriting Review</span>
            </div>
          </div>
          ...
          {loading ? (
            ...
            /* ========================================================================= */
            <div className="glass-panel p-6 rounded-2xl border border-[#DFBD84]/15 space-y-4 bg-[#15203B]/85 text-[#FAF7E6]/60 shadow-2xl">
              {/* Search & Filter Bar */}
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-[#15203B]/85 text-[#FAF7E6] p-3.5 rounded-xl border border-[#DFBD84]/15">
                ...
                <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto text-xs">
                  <select
                    ...
                    className="bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15 rounded-lg p-2 font-semibold cursor-pointer"
                  >
                    <option value="all" className="bg-[#15203B]/85 text-[#FAF7E6]">All Loan Statuses</option>
                    <option value="draft" className="bg-[#15203B]/85 text-[#FAF7E6]">Applied / Draft</option>
                    <option value="underwriting" className="bg-[#15203B]/85 text-[#FAF7E6]">In Underwriting</option>
                    <option value="on_hold" className="bg-[#15203B]/85 text-[#FAF7E6]">On Hold</option>
                    <option value="approved" className="bg-[#15203B]/85 text-[#FAF7E6]">Approved</option>
                    <option value="disbursed" className="bg-[#15203B]/85 text-[#FAF7E6]">Disbursed</option>
                    <option value="rejected" className="bg-[#15203B]/85 text-[#FAF7E6]">Rejected</option>
                  </select>
                  ...
                  <select
                    ...
                    className="bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15 rounded-lg p-2 font-semibold cursor-pointer"
                  >
                    <option value="all" className="bg-[#15203B]/85 text-[#FAF7E6]">All Categories</option>
                    <option value="corporate" className="bg-[#15203B]/85 text-[#FAF7E6]">Corporate Enterprise</option>
                    <option value="sme" className="bg-[#15203B]/85 text-[#FAF7E6]">SME Business</option>
                    <option value="private_individual" className="bg-[#15203B]/85 text-[#FAF7E6]">Private Individual</option>
                  </select>

                  <button
                    onClick={handleExportCSV}
                    className="px-3 py-2 bg-[#15203B]/85 text-[#FAF7E6] hover:bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] rounded-lg border border-[#DFBD84]/15 font-bold transition flex items-center space-x-1"
                  >
              ...
              {selectedLoanIds.length > 0 && (
                <div className="p-3 bg-[#1E2D4E]/20 border border-[#DFBD84]/15 rounded-xl flex items-center justify-between text-xs text-[#FAF7E6] shadow-lg">
                ...
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-[#DFBD84]/15 text-[#FAF7E6] uppercase tracking-wider text-[10px] bg-[#15203B]/85 text-[#FAF7E6]">
                      <th className="py-3 px-3 w-10 text-center">
                        <button onClick={handleToggleSelectAll} className="text-[#FAF7E6]" title="Select All">
                  ...
                  <tbody className="divide-y divide-[#DFBD84]/15">
                    {filteredDatabaseLoans.length === 0 ? (
                      <tr>
                        <td colSpan="10" className="py-8 text-center text-[#94A3B8] italic text-xs">
                      ...
                      filteredDatabaseLoans.map((l) => {
                        ...
                        return (
                          <tr key={l.id || Math.random()} className={`hover:bg-[#15203B]/85 text-[#FAF7E6]/60 transition ${isSelected ? 'bg-[#15203B]/85 text-[#FAF7E6]/80 border-l-4 border-l-[#1E2748]' : ''}`}>
                            <td className="py-3.5 px-3 text-center">
                              <button onClick={() => handleToggleSelectRow(l.id)} className="text-[#FAF7E6]">
                                {isSelected ? <CheckSquare className="w-4 h-4 text-[#FAF7E6]" /> : <Square className="w-4 h-4 text-[#94A3B8]" />}
                              </button>
                            </td>
                            ...
                            <td className="py-3.5 px-3 space-y-0.5">
                              ...
                              <span className="text-[10px] text-[#FAF7E6] font-mono block">{accNum}</span>
                            </td>
                            ...
                            <td className="py-3.5 px-3 text-center">
                              <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase border ${
                                l.status === 'disbursed'
                                  ...
                                  : 'bg-[#1E2D4E]/20 text-[#FAF7E6] border-[#DFBD84]/15'
                              }`}>
                            ...
                            <td className="py-3.5 px-3 text-center font-mono font-bold">
                              <span className={l.risk_score > 70 ? 'text-red-400' : l.risk_score > 40 ? 'text-[#FAF7E6]' : 'text-[#58b388]'}>
                                {l.risk_score || 35}/100
                              </span>
                            </td>
                            ...
                            <td className="py-3.5 px-3 text-center">
                              <div className="flex items-center justify-center space-x-1.5">
                                ...
                                <button
                                  onClick={() => setSelectedDetailLoan(l)}
                                  className="p-1.5 bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] hover:bg-[#1E2D4E] hover:text-[#FAF7E6] rounded-lg transition border border-[#DFBD84]/15 cursor-pointer"
                                ...
                                <button
                                  ...
                                  className="p-1.5 bg-[#1E2D4E]/10 text-[#FAF7E6] hover:bg-[#1E2D4E] hover:text-[#FAF7E6] rounded-lg transition border border-[#DFBD84]/15 cursor-pointer"
          ...
          <div className="glass-panel w-full max-w-lg p-6 rounded-2xl border border-[#DFBD84]/15 bg-[#15203B]/85 text-[#FAF7E6] shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#DFBD84]/15">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#FAF7E6]">Modify Loan Database Record</h3>
                  <p className="text-[11px] text-[#FAF7E6]">Loan Ref: #{editingLoan.id.slice(0, 8)}</p>
                </div>
              </div>
              <button onClick={() => setEditingLoan(null)} className="text-[#94A3B8] hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleUpdateLoanRecord} className="space-y-3 text-xs">
              <div>
                <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Applicant Full Name</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Principal Amount ($)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Interest Rate (%)</label>
                  <input
                    type="number"
                    step="0.1"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Term (Months)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Loan Status</label>
                  <select
                    value={editingLoan.status || 'draft'}
                    onChange={(e) => setEditingLoan({ ...editingLoan, status: e.target.value })}
                    className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] border border-[#DFBD84]/15 rounded-xl p-2.5 text-[#FAF7E6] font-bold"
                  >
                    <option value="draft" className="bg-[#15203B]/85 text-[#FAF7E6]">Draft / Applied</option>
                    <option value="underwriting" className="bg-[#15203B]/85 text-[#FAF7E6]">In Underwriting</option>
                    <option value="approved" className="bg-[#15203B]/85 text-[#FAF7E6]">Approved</option>
                    <option value="disbursed" className="bg-[#15203B]/85 text-[#FAF7E6]">Disbursed</option>
                    <option value="rejected" className="bg-[#15203B]/85 text-[#FAF7E6]">Rejected</option>
              ...
              <div>
                <label className="block text-[#FAF7E6] font-bold mb-1 uppercase text-[10px]">Requisition Purpose</label>
                <input
                  type="text"
              ...
              <div className="pt-3 flex justify-end space-x-2 border-t border-[#DFBD84]/15">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] hover:from-[#DFBD84] hover:to-[#EED29E] text-[#0B1120] font-black font-black rounded-xl shadow-lg transition disabled:opacity-50 cursor-pointer"
                >
