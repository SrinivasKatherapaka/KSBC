          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="px-3.5 py-2 bg-rose-950 hover:bg-[#EBE4CD] text-amber-300 text-xs font-bold rounded-xl border border-rose-800/60 transition flex items-center space-x-1.5"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[#EBE4CD] hover:bg-[#141C33] text-white text-xs font-bold rounded-xl shadow-lg shadow-[#FFFFFF]/30 transition flex items-center space-x-2 border border-[#1E2748]/15"
              >
