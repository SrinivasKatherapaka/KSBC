...
export const FreshLoanApplicationsPage = () => {
  ...
  const renderStatusBadge = (status) => {
    switch (status) {
      ...
      case 'underwriting':
        return <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-extrabold bg-[#EBE4CD]/10 text-[#1E2748] border border-[#1E2748]/15">⚙️ UNDERWRITING</span>;
      default:
    ...
    <div className="flex min-h-screen bg-[#FAF7E6] text-[#1E2748] text-[#53627C]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h1 className="text-2xl font-extrabold text-[#1E2748] font-heading flex items-center space-x-2">
                    ...
                    <span className="px-2 py-0.5 bg-[#1E2748] text-[#FAF7E6] font-archivo font-extrabold rounded-md text-[10px] font-black uppercase tracking-wider">
                      Live AI Risk Engine
                    </span>
                  </h1>
          ...
          <div className="flex items-center space-x-2 border-b border-[#1E2748]/15 pb-3">
            <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-7 glass-panel p-6 rounded-2xl border border-[#1E2748]/15 space-y-5 bg-[#F6F2E3] text-[#1E2748]/60 shadow-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-[#1E2748]/15">
                  ...
                  <span className="text-[11px] font-mono text-[#1E2748] bg-[#F6F2E3] text-[#1E2748] px-2.5 py-1 rounded-lg border border-[#1E2748]/15">
                ...
                <form onSubmit={handleSubmitIntake} className="space-y-4 text-xs">
                  ...
                  <div className="p-3 bg-[#F6F2E3] text-[#1E2748]/90 rounded-xl border border-[#1E2748]/15 space-y-2">
                  ...
                  <div className="p-4 bg-[#EBE4CD]/70 rounded-2xl border border-[#1E2748]/15 space-y-3">
                  ...
                  <div className="pt-2 flex items-center justify-end space-x-3">
                    <button
                      type="submit"
                      disabled={submitting}
                      className="w-full sm:w-auto px-8 py-3 bg-[#1E2748] hover:bg-[#141C33] text-[#FAF7E6] font-archivo font-extrabold text-xs font-black rounded-xl shadow-xl shadow-[#FFFFFF]/50 transition disabled:opacity-50 border border-[#1E2748]/15/60 flex items-center justify-center space-x-2 cursor-pointer"
                    >
                      {submitting ? (
                        <>
                          <Loader2 className="w-4 h-4 animate-spin text-[#1E2748]" />
          ...
          {activeSubTab === 'queue' && (
            <div className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-3 bg-[#F6F2E3] text-[#1E2748] p-4 rounded-2xl border border-[#1E2748]/15 shadow-lg">
                        ...
                        <div className="pt-3 border-t border-[#1E2748]/15 space-y-2">
                          ...
                          <div className="grid grid-cols-3 gap-1.5">
                            ...
                            <button
                              ...
                              className="py-1.5 bg-[#58b388] hover:bg-emerald-400 text-[#1E2748] text-[10px] font-black rounded-lg transition flex items-center justify-center space-x-1 disabled:opacity-30 cursor-pointer"
                            ...
                            <button
                              ...
                              className="py-1.5 bg-amber-500 hover:bg-amber-400 text-[#1E2748] text-[10px] font-black rounded-lg transition flex items-center justify-center space-x-1 disabled:opacity-30 cursor-pointer"
                              title="Place on Hold"
                            >
                              ...
                              <td className="py-3.5 px-3 text-center">
                                <div className="flex items-center justify-center space-x-1.5">
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 bg-[#58b388] text-[#1E2748] rounded text-[10px] font-black disabled:opacity-30 cursor-pointer"
                                  >
                                    Approve
                                  </button>
                                  <button
                                    ...
                                    className="px-2 py-1 bg-amber-500 text-[#1E2748] rounded text-[10px] font-black disabled:opacity-30 cursor-pointer"
                                  >
                                    On Hold
                                  </button>
                                  <button
            ...
            <div className="space-y-6">
              ...
              <div className="glass-panel p-6 rounded-2xl border border-[#1E2748]/15 bg-[#F6F2E3] text-[#1E2748]/70 space-y-4 shadow-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-[#1E2748]/15">
                  ...
                  <span className="text-[10px] font-mono text-[#1E2748] bg-[#F6F2E3] text-[#1E2748] px-2.5 py-1 rounded-lg border border-[#1E2748]/15">
