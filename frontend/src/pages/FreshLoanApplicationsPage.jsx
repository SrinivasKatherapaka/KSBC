...
export const FreshLoanApplicationsPage = () => {
  ...
  const liveRiskCalculation = useMemo(() => {
    ...
    if (calculatedScore > 70) {
      ...
      riskColor = 'text-[#FAF7E6]';
      riskBg = 'bg-[#1E2D4E]/10 border-[#DFBD84]/15';
    }
  ...
  const renderCategoryBadge = (cat) => {
    ...
    if (cat === 'sme') {
      return <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15">🏬 SME Business</span>;
    }
    return <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15">🏢 Corporate</span>;
  };
  ...
  const renderStatusBadge = (status) => {
    switch (status) {
      ...
      case 'underwriting':
        return <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-extrabold bg-[#1E2D4E]/10 text-[#FAF7E6] border border-[#DFBD84]/15">⚙️ UNDERWRITING</span>;
      default:
    ...
    <div className="flex min-h-screen bg-[#0B1120] text-[#FAF7E6] text-[#94A3B8]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center space-x-2.5">
                <div className="p-2 bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] rounded-xl border border-[#DFBD84]/15 shadow-md">
                  <FileCheck className="w-6 h-6 text-[#FAF7E6]" />
                </div>
                <div>
                  <h1 className="text-2xl font-extrabold text-[#FAF7E6] font-heading flex items-center space-x-2">
                    ...
                    <span className="px-2 py-0.5 bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] text-[#0B1120] font-black rounded-md text-[10px] font-black uppercase tracking-wider">
                      Live AI Risk Engine
                    </span>
                  </h1>
            ...
            <div className="flex items-center space-x-2">
              <Link
                ...
                className="px-3.5 py-2 bg-[#15203B]/85 text-[#FAF7E6] border border-[#DFBD84]/15 text-[#FAF7E6] hover:text-[#FAF7E6] text-xs font-bold rounded-xl transition flex items-center space-x-1.5"
              >
          ...
          <div className="flex items-center space-x-2 border-b border-[#DFBD84]/15 pb-3">
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-black transition flex items-center space-x-2 cursor-pointer ${
                activeSubTab === 'intake'
                  ? 'bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] hover:from-[#DFBD84] hover:to-[#EED29E] text-[#0B1120] font-black shadow-lg shadow-[#FFFFFF]/40 border border-[#DFBD84]/15'
                  : 'bg-[#15203B]/85 text-[#FAF7E6]/70 text-[#94A3B8] hover:text-[#FAF7E6] hover:bg-[#15203B]/85 text-[#FAF7E6] border border-transparent'
              }`}
            >
            ...
            >
              ...
              <span className="px-1.5 py-0.2 rounded-full bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] text-[10px] font-mono font-bold">
                {loans.length}
              </span>
            </button>
          ...
          {activeSubTab === 'intake' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-7 glass-panel p-6 rounded-2xl border border-[#DFBD84]/15 space-y-5 bg-[#15203B]/85 text-[#FAF7E6]/60 shadow-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-[#DFBD84]/15">
                  <div>
                    <h3 className="font-extrabold text-[#FAF7E6] text-base flex items-center space-x-2">
                  ...
                  <span className="text-[11px] font-mono text-[#FAF7E6] bg-[#15203B]/85 text-[#FAF7E6] px-2.5 py-1 rounded-lg border border-[#DFBD84]/15">
                ...
                <form onSubmit={handleSubmitIntake} className="space-y-4 text-xs">
                  ...
                  <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6]/90 rounded-xl border border-[#DFBD84]/15 space-y-2">
                    <label className="block text-[11px] font-bold text-[#FAF7E6] uppercase tracking-wider">
                      Select Existing Onboarded Account (Optional Auto-Fill)
                    </label>
                    <select
                      value={selectedCustomerId}
                      onChange={(e) => handleCustomerSelect(e.target.value)}
                      className="w-full glass-input bg-[#0B1120] text-[#FAF7E6] rounded-xl p-2.5 font-medium"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block font-bold text-[#FAF7E6] mb-1">
                      ...
                      <input
                        ...
                        className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-xl p-2.5"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-xl p-2.5 font-medium"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        <span className="absolute left-3 top-2.5 text-[#FAF7E6] font-bold">$</span>
                        <input
                          type="number"
                          min="1000"
                          max="100000000"
                          ...
                          className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-xl p-2.5 pl-7 font-mono font-bold"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-xl p-2.5 font-mono"
                        required
                      />
                    </div>
                  ...
                  <div className="p-3.5 bg-[#15203B]/85 text-[#FAF7E6]/70 rounded-xl border border-[#DFBD84]/15 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold text-[#FAF7E6] uppercase tracking-wider flex items-center space-x-1.5">
                        <Sparkles className="w-3.5 h-3.5 text-[#FAF7E6]" />
                        <span>Applicant Financial Verification Telemetry</span>
                      </span>
                      <span className="text-[10px] text-[#94A3B8]">Used for Live Risk Engine</span>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        <label className="block text-[10px] text-[#94A3B8] font-semibold mb-1">
                        ...
                        <input
                          ...
                          className="w-full glass-input bg-[#0F172A] text-white rounded-lg p-2 font-mono"
                        />
                      </div>
                  ...
                  <div className="p-4 bg-[#0F172A]/70 rounded-2xl border border-[#DFBD84]/15 space-y-3">
                    <label className="block font-bold text-[#FAF7E6] text-xs uppercase tracking-wider flex items-center justify-between">
                      <span>Immediate Action Outcome On Registration</span>
                      <span className="text-[10px] font-normal text-[#FAF7E6]">Choose initial underwriting state</span>
                    </label>
                      ...
                      <button
                        ...
                        className={`p-2.5 rounded-xl border text-center font-extrabold text-[11px] transition flex flex-col items-center justify-center space-y-1 cursor-pointer ${
                          initialAction === 'underwriting'
                            ? 'bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] text-[#0B1120] font-black border-[#DFBD84]/15 shadow-md'
                            : 'bg-[#15203B]/85 text-[#FAF7E6] text-[#94A3B8] border-[#DFBD84]/15 hover:text-white'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-2.5 rounded-xl border text-center font-extrabold text-[11px] transition flex flex-col items-center justify-center space-y-1 cursor-pointer ${
                          initialAction === 'approved'
                            ? 'bg-[#58b388] text-[#FAF7E6] border-[#58b388] shadow-md'
                            : 'bg-[#15203B]/85 text-[#FAF7E6] text-[#94A3B8] border-[#DFBD84]/15 hover:text-white'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-2.5 rounded-xl border text-center font-extrabold text-[11px] transition flex flex-col items-center justify-center space-y-1 cursor-pointer ${
                          initialAction === 'on_hold'
                            ? 'bg-amber-500 text-[#FAF7E6] border-amber-500 shadow-md'
                            : 'bg-[#15203B]/85 text-[#FAF7E6] text-[#94A3B8] border-[#DFBD84]/15 hover:text-white'
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-lg p-2"
                      />
                    </div>
                  </div>
                  ...
                  <div className="pt-2 flex items-center justify-end space-x-3">
                    <button
                      type="submit"
                      disabled={submitting}
                      className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] hover:from-[#DFBD84] hover:to-[#EED29E] text-[#0B1120] font-black text-xs font-black rounded-xl shadow-xl shadow-[#FFFFFF]/50 transition disabled:opacity-50 border border-[#DFBD84]/15/60 flex items-center justify-center space-x-2 cursor-pointer"
                    >
                      {submitting ? (
                        <>
                          <Loader2 className="w-4 h-4 animate-spin text-[#FAF7E6]" />
              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="glass-panel p-6 rounded-2xl border border-[#DFBD84]/15 bg-[#15203B]/85 text-[#FAF7E6]/80 shadow-2xl space-y-4 relative overflow-hidden">
                  <div className="flex items-center justify-between pb-3 border-b border-[#DFBD84]/15">
                    <div className="flex items-center space-x-2">
                      <div className="p-2 bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] rounded-xl border border-[#DFBD84]/15">
                        <Sparkles className="w-5 h-5 text-[#FAF7E6]" />
                      </div>
                      <div>
                        <h4 className="font-extrabold text-[#FAF7E6] text-sm">Calculated Risk Engine Output</h4>
                        <p className="text-[10px] text-[#FAF7E6]">Real-time underwriting analysis</p>
                      </div>
                    </div>
                    <span className="px-2 py-0.5 rounded-full bg-[#15203B]/85 text-[#FAF7E6] text-[9px] font-mono text-emerald-400 border border-emerald-500/30">
                      LIVE COMPUTED
                    </span>
                  </div>

                  {/* Main Score Gauge */}
                  <div className="p-4 bg-[#15203B]/85 text-[#FAF7E6] rounded-2xl border border-[#DFBD84]/15 flex items-center justify-between">
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6]/80 rounded-xl border border-[#DFBD84]/15">
                      <span className="text-[9px] text-[#94A3B8] block">DEBT-TO-INCOME (DTI)</span>
                      <span className="text-sm font-extrabold text-[#FAF7E6] font-mono">
                        {(liveRiskCalculation.dtiRatio * 100).toFixed(1)}%
                      </span>
                      <span className="text-[9px] text-[#FAF7E6] block mt-0.5">
                        ${liveRiskCalculation.monthlyPayment.toLocaleString()}/mo
                      </span>
                    </div>

                    <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6]/80 rounded-xl border border-[#DFBD84]/15">
                      <span className="text-[9px] text-[#94A3B8] block">COLLATERAL COVERAGE</span>
                      <span className="text-sm font-extrabold text-[#FAF7E6] font-mono">
                    ...
                    <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6]/80 rounded-xl border border-[#DFBD84]/15">
                      <span className="text-[9px] text-[#94A3B8] block">MAX RECOMMENDED LOAN</span>
                      <span className="text-sm font-extrabold text-[#58b388] font-mono">
                        ${liveRiskCalculation.maxRecommendedLoan.toLocaleString()}
                      </span>
                      <span className="text-[9px] text-[#94A3B8] block mt-0.5">42% Revenue Cap</span>
                    </div>

                    <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6]/80 rounded-xl border border-[#DFBD84]/15">
                      <span className="text-[9px] text-[#94A3B8] block">REQUEST RATIO</span>
                      <span className="text-sm font-extrabold text-[#FAF7E6] font-mono">
                        {((Number(principalAmount) / Math.max(Number(annualRevenue), 1)) * 100).toFixed(1)}%
                      </span>
                      <span className="text-[9px] text-[#94A3B8] block mt-0.5">Principal / Revenue</span>
                    </div>
                  </div>

                  {/* Key Risks & Mitigations */}
                  <div className="space-y-2 pt-2 border-t border-[#DFBD84]/15">
                    <h5 className="text-[11px] font-bold text-[#FAF7E6] uppercase tracking-wider">
          ...
          {activeSubTab === 'queue' && (
            <div className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-3 bg-[#15203B]/85 text-[#FAF7E6] p-4 rounded-2xl border border-[#DFBD84]/15 shadow-lg">
                ...
                <div className="flex flex-wrap items-center gap-2 w-full md:w-auto text-xs">
                  <select
                    ...
                    className="bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15 rounded-lg p-2 font-semibold cursor-pointer text-xs"
                  >
                  ...
                  <div className="flex items-center space-x-1 bg-[#15203B]/85 text-[#FAF7E6] p-1 rounded-lg border border-[#DFBD84]/15">
                    <button
                      onClick={() => setViewLayout('cards')}
                      className={`p-1.5 rounded cursor-pointer ${viewLayout === 'cards' ? 'bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] text-[#0B1120] font-black' : 'text-[#94A3B8]'}`}
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded cursor-pointer ${viewLayout === 'table' ? 'bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] text-[#0B1120] font-black' : 'text-[#94A3B8]'}`}
              ...
              {loading ? (
                ...
                <div className="glass-panel p-12 text-center rounded-2xl border border-[#DFBD84]/15 bg-[#15203B]/85 text-[#FAF7E6]/40 space-y-3">
                  <FileText className="w-12 h-12 text-[#FAF7E6]/50 mx-auto" />
                  <h4 className="text-base font-bold text-[#FAF7E6]">No Loan Applications Match Filters</h4>
                  <p className="text-xs text-[#94A3B8]">Try adjusting your search criteria or register a new loan application in the Intake tab.</p>
                  <button
                    onClick={() => setActiveSubTab('intake')}
                    className="px-4 py-2 bg-gradient-to-r from-[#C59E5F] via-[#DFBD84] to-[#C59E5F] text-[#0B1120] font-black font-bold rounded-xl text-xs cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredQueueLoans.map((loan) => {
                    ...
                    return (
                      <div
                        key={loan.id}
                        className="glass-panel p-4 rounded-2xl border border-[#DFBD84]/15 space-y-3 bg-[#15203B]/85 text-[#FAF7E6]/60 hover:border-[#DFBD84]/15/60 transition shadow-xl relative flex flex-col justify-between"
                      >
                        <div>
                          {/* Card Header */}
                          ...
                          {/* Loan Numbers Box */}
                          <div className="mt-3 p-2.5 bg-[#15203B]/85 text-[#FAF7E6]/90 rounded-xl border border-[#DFBD84]/15 font-mono text-xs flex justify-between">
                            <div>
                              <span className="text-[9px] text-[#94A3B8] font-sans block">PRINCIPAL</span>
                              <span className="font-extrabold text-[#FAF7E6] text-sm">
                                ${Number(loan.principal_amount || 0).toLocaleString()}
                              </span>
                            </div>
                            <div className="text-right">
                              <span className="text-[9px] text-[#94A3B8] font-sans block">RATE / TERM</span>
                              <span className="font-bold text-[#FAF7E6]">
                          ...
                          <div className="mt-2.5 space-y-1 text-xs">
                            <p className="text-[11px] text-[#94A3B8] line-clamp-1">
                              <span className="text-[#FAF7E6] font-bold">Purpose:</span> {loan.purpose || 'Commercial Growth'}
                            </p>
                            {loan.decision_notes && (
                              <p className="text-[10px] italic text-[#FAF7E6]/80 line-clamp-2 bg-[#15203B]/85 text-[#FAF7E6]/50 p-1.5 rounded border border-[#DFBD84]/15/15">
                                💬 "{loan.decision_notes}"
                              </p>
                            )}
                          </div>
                        ...
                        <div className="pt-3 border-t border-[#DFBD84]/15 space-y-2">
                          <div className="flex items-center justify-between text-[10px] text-[#FAF7E6] font-bold uppercase">
                            <span>Execute Outcome Action:</span>
                            <button
                              onClick={() => setSelectedDetailLoan(loan)}
                              className="text-[10px] text-[#FAF7E6] hover:text-[#FAF7E6] hover:underline font-bold flex items-center space-x-1 cursor-pointer"
                            >
                          ...
                          <div className="grid grid-cols-3 gap-1.5">
                            ...
                            <button
                              ...
                              className="py-1.5 bg-[#58b388] hover:bg-emerald-400 text-[#FAF7E6] text-[10px] font-black rounded-lg transition flex items-center justify-center space-x-1 disabled:opacity-30 cursor-pointer"
                            ...
                            <button
                              ...
                              className="py-1.5 bg-amber-500 hover:bg-amber-400 text-[#FAF7E6] text-[10px] font-black rounded-lg transition flex items-center justify-center space-x-1 disabled:opacity-30 cursor-pointer"
                              title="Place on Hold"
                            >
                          ...
                          <div className="flex items-center justify-between pt-1 text-[10px]">
                            <button
                              ...
                              className="text-[#FAF7E6] hover:text-[#FAF7E6] flex items-center space-x-1 disabled:opacity-50 cursor-pointer"
                            >
                ...
                /* Table Layout */
                <div className="glass-panel rounded-2xl border border-[#DFBD84]/15 overflow-hidden shadow-2xl bg-[#15203B]/85 text-[#FAF7E6]/50">
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-[#DFBD84]/15">
                        {filteredQueueLoans.map((loan) => {
                          ...
                          return (
                            <tr key={loan.id} className="hover:bg-[#15203B]/85 text-[#FAF7E6]/60 transition">
                              <td className="py-3.5 px-3 font-mono font-bold">
                                <button
                                  onClick={() => setSelectedDetailLoan(loan)}
                                  className="text-[#FAF7E6] hover:text-[#FAF7E6] hover:underline flex items-center space-x-1 cursor-pointer group"
                              ...
                              <td className="py-3.5 px-3 space-y-1">
                                <button
                                  onClick={() => setSelectedDetailLoan(loan)}
                                  className="font-bold text-[#FAF7E6] hover:text-[#FAF7E6] text-left block cursor-pointer transition"
                                >
                                  {displayName}
                                </button>
                                {renderCategoryBadge(category)}
                              ...
                              <td className="py-3.5 px-3 text-[11px] text-[#94A3B8] max-w-xs truncate">
                                {loan.purpose}
                              </td>
                              ...
                              <td className="py-3.5 px-3 text-center">
                                <div className="flex items-center justify-center space-x-1.5">
                                  <button
                                    onClick={() => setSelectedDetailLoan(loan)}
                                    className="p-1 bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] border border-[#DFBD84]/15 hover:bg-[#1E2D4E] hover:text-[#FAF7E6] rounded text-[10px] font-bold cursor-pointer"
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 bg-[#58b388] text-[#FAF7E6] rounded text-[10px] font-black disabled:opacity-30 cursor-pointer"
                                  >
                                    Approve
                                  </button>
                                  <button
                                    ...
                                    className="px-2 py-1 bg-amber-500 text-[#FAF7E6] rounded text-[10px] font-black disabled:opacity-30 cursor-pointer"
                                  >
                                    On Hold
                                  </button>
                                  <button
          ...
          {activeSubTab === 'audit' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="glass-panel p-4 rounded-2xl border border-[#DFBD84]/15 bg-[#15203B]/85 text-[#FAF7E6]/60 space-y-1 shadow-lg">
                  <div className="flex justify-between items-center text-[#FAF7E6]">
                    <span className="text-[10px] font-bold uppercase tracking-wider">Total Intake Volume</span>
                    <FileText className="w-4 h-4" />
                  </div>
                  <p className="text-xl font-extrabold text-[#FAF7E6] font-mono">
                    ${auditMetrics.totalVolume.toLocaleString()}
                  </p>
                  <p className="text-[10px] text-[#FAF7E6] font-mono">
                    {auditMetrics.totalCount} Total Applications Registered
                  </p>
                </div>

                <div className="glass-panel p-4 rounded-2xl border border-[#58b388]/30 bg-[#15203B]/85 text-[#FAF7E6]/60 space-y-1 shadow-lg">
                ...
                <div className="glass-panel p-4 rounded-2xl border border-amber-500/30 bg-[#15203B]/85 text-[#FAF7E6]/60 space-y-1 shadow-lg">
                ...
                <div className="glass-panel p-4 rounded-2xl border border-red-500/30 bg-[#15203B]/85 text-[#FAF7E6]/60 space-y-1 shadow-lg">
              ...
              <div className="glass-panel p-6 rounded-2xl border border-[#DFBD84]/15 bg-[#15203B]/85 text-[#FAF7E6]/70 space-y-4 shadow-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-[#DFBD84]/15">
                  <div>
                    <h3 className="font-extrabold text-[#FAF7E6] text-base">Underwriting Action Decision Logs & Audit Trail</h3>
                    <p className="text-xs text-[#FAF7E6]">Chronological record of status changes, reasons, and underwriting actions</p>
                  </div>
                  <span className="text-[10px] font-mono text-[#FAF7E6] bg-[#15203B]/85 text-[#FAF7E6] px-2.5 py-1 rounded-lg border border-[#DFBD84]/15">
                  ...
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-[#DFBD84]/15">
                      {loans.map((l) => {
                        ...
                        return (
                          <tr key={l.id} className="hover:bg-[#15203B]/85 text-[#FAF7E6]/60 transition">
                            ...
                            <td className="py-3 px-3 font-bold text-[#FAF7E6]">
                              <button
                                onClick={() => setSelectedDetailLoan(l)}
                                className="hover:text-[#FAF7E6] text-left cursor-pointer transition"
                              >
                                {displayName}
                              </button>
                            </td>
                            <td className="py-3 px-3 text-right font-mono font-extrabold text-[#FAF7E6]">
                            ...
                            <td className="py-3 px-3 text-[11px] text-[#94A3B8]">
                              {l.decision_notes || (l.action_logs?.[0]?.notes) || 'Underwriting intake record recorded'}
                            </td>
                            <td className="py-3 px-3 text-right font-mono text-[10px] text-[#FAF7E6]">
      ...
      {actionModalLoan && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="glass-panel w-full max-w-lg p-6 rounded-2xl border border-[#DFBD84]/15 shadow-2xl relative bg-[#15203B]/85 text-[#FAF7E6] space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#DFBD84]/15">
              <div className="flex items-center space-x-2">
                <div className="p-2 bg-[#15203B]/85 text-[#FAF7E6] text-[#FAF7E6] rounded-xl border border-[#DFBD84]/15">
                  <CheckCircle2 className="w-5 h-5 text-[#FAF7E6]" />
                </div>
                <div>
                  <h3 className="font-extrabold text-[#FAF7E6] text-sm">
                    Execute Outcome Action: {actionType.toUpperCase().replace('_', ' ')}
                  </h3>
                  <p className="text-[10px] text-[#FAF7E6]">
                    Loan #{actionModalLoan.id?.slice(0, 8)} - {actionModalLoan.applicant_name}
                  </p>
                </div>
              </div>
              <button onClick={() => setActionModalLoan(null)} className="text-[#94A3B8] hover:text-white cursor-pointer">
                <X className="w-5 h-5" />
              </button>
            </div>

            <div className="p-3 bg-[#15203B]/85 text-[#FAF7E6] rounded-xl border border-[#DFBD84]/15 space-y-2 text-xs">
              <div className="flex justify-between">
                <span className="text-[#94A3B8]">Requested Principal:</span>
                <span className="font-mono font-bold text-[#FAF7E6]">${Number(actionModalLoan.principal_amount || 0).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#94A3B8]">Calculated AI Risk Score:</span>
                <span className="font-mono font-bold text-[#FAF7E6]">{actionModalLoan.risk_score || 35}/100</span>
              </div>
            </div>

            <div className="space-y-1.5 text-xs">
              <label className="block font-bold text-[#FAF7E6]">
              ...
              <textarea
                ...
                className="w-full glass-input bg-[#15203B]/85 text-[#FAF7E6] text-white rounded-xl p-2.5 text-xs"
                required
              />
            </div>
