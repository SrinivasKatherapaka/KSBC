        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-rose-300/60">Real-Time Gemini 2.5 Anomaly Scoring & Anti-Money Laundering (AML) Sentinel</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-7 glass-panel p-5 rounded-2xl border border-rose-900/30 space-y-4">
                <h3 className="text-sm font-bold text-white flex items-center space-x-2 pb-2 border-b border-rose-900/30">
                ...
                <div className="space-y-3">
                  {fraudAlerts.map((tx) => {
                    ...
                    return (
                      <div key={tx.transactionId} className="p-4 bg-rose-950/40 rounded-xl border border-rose-900/40 space-y-3 hover:border-rose-600/50 transition">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-mono p-2.5 bg-rose-950/60 rounded-lg">
                          <div>
                        ...
                        <div className="pt-2 border-t border-rose-900/30 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-gradient-to-r from-rose-800 to-rose-950 hover:from-rose-700 hover:to-rose-900 text-white text-xs font-bold rounded-xl shadow transition flex items-center space-x-1.5 disabled:opacity-50 border border-rose-600/40"
                          >
              ...
              <div className="lg:col-span-5 space-y-4">
                {analysisResult ? (
                  <div className="glass-panel p-6 rounded-2xl border border-rose-900/40 space-y-4 shadow-2xl bg-rose-950/20">
                    ...
                    <div className="p-3 bg-rose-950/60 rounded-xl border border-rose-900/40 text-xs font-mono space-y-1">
                    ...
                    <div className="space-y-2 text-xs">
                      <span className="font-bold text-rose-300 block text-[11px] uppercase tracking-wider">Detected Anomaly Signals:</span>
