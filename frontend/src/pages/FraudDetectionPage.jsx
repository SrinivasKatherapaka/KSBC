        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-[#FAF7E6]/70">Real-Time Gemini 2.5 Anomaly Scoring & Anti-Money Laundering (AML) Sentinel</p>
            </div>
              ...
              <div className="lg:col-span-7 glass-panel p-5 rounded-2xl border border-[#DFBD84]/15 space-y-4">
                ...
                <div className="space-y-3">
                  {fraudAlerts.map((tx) => {
                    ...
                    return (
                      <div key={tx.transactionId} className="p-4 bg-[#15203B]/85 text-[#FAF7E6]/60 rounded-xl border border-[#DFBD84]/15 space-y-3 hover:border-rose-600/50 transition">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-mono p-2.5 bg-[#15203B]/85 text-[#FAF7E6] rounded-lg">
                          <div>
                        ...
                        {/* Action buttons */}
                        <div className="pt-2 border-t border-[#DFBD84]/15 flex items-center justify-between">
                          {isFrozen ? (
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-[#1E2D4E] hover:bg-[#141C33] text-white text-xs font-bold rounded-xl shadow transition flex items-center space-x-1.5 disabled:opacity-50 border border-[#DFBD84]/15"
                          >
                ...
                {analysisResult ? (
                  <div className="glass-panel p-6 rounded-2xl border border-[#DFBD84]/15 space-y-4 shadow-2xl bg-rose-950/20">
                    ...
                    <div className="space-y-2 text-xs">
                      <span className="font-bold text-[#FAF7E6] block text-[11px] uppercase tracking-wider">Detected Anomaly Signals:</span>
