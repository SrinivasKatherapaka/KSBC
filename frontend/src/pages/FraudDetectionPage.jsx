                  ...
                  {fraudAlerts.map((tx) => {
                    ...
                    return (
                      <div key={tx.transactionId} className="p-4 bg-[#F6F2E3] text-[#1E2748]/60 rounded-xl border border-[#1E2748]/15 space-y-3 hover:border-rose-600/50 transition">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-mono p-2.5 bg-[#F6F2E3] text-[#1E2748] rounded-lg">
                          <div>
                        ...
                        <div className="pt-2 border-t border-[#1E2748]/15 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-[#EBE4CD] hover:bg-[#141C33] text-white text-xs font-bold rounded-xl shadow transition flex items-center space-x-1.5 disabled:opacity-50 border border-[#1E2748]/15"
                          >
