        ...
        <main className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className={`p-5 rounded-2xl border transition-all ${
            isIdUnlocked
              ...
              : 'bg-[#F6F2E3] text-[#1E2748]/95 border-amber-500/40 shadow-xl'
          }`}>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div>
                {!isIdUnlocked ? (
                  <button
                    onClick={() => setIsSpecialAuthModalOpen(true)}
                    className="px-5 py-3 bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-400 text-[#1E2748] font-black rounded-xl shadow-lg border border-amber-300/50 transition flex items-center space-x-2 text-xs"
                  >
                    <KeyRound className="w-4 h-4 text-[#1E2748]" />
          ...
          <div className="glass-panel p-5 rounded-2xl border border-[#1E2748]/15 bg-[#F6F2E3] text-[#1E2748]/60 space-y-3 shadow-xl">
            ...
            <p className="text-xs text-[#1E2748] leading-relaxed font-mono bg-[#F6F2E3] text-[#1E2748] p-4 rounded-xl border border-[#1E2748]/15">
            ...
            <div className="glass-panel p-5 rounded-2xl border border-[#1E2748]/15 bg-[#F6F2E3] text-[#1E2748]/60 space-y-4 shadow-xl">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-[#1E2748]/15 text-[#1E2748] uppercase text-[10px] bg-[#F6F2E3] text-[#1E2748]">
