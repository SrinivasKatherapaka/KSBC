            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div>
                {!isIdUnlocked ? (
                  <button
                    onClick={() => setIsSpecialAuthModalOpen(true)}
                    className="px-5 py-3 bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-400 text-[#FAF7E6] font-black rounded-xl shadow-lg border border-amber-300/50 transition flex items-center space-x-2 text-xs"
                  >
                    <KeyRound className="w-4 h-4 text-[#FAF7E6]" />
