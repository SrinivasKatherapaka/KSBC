      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 md:p-8 space-y-6 max-w-5xl mx-auto w-full flex-1 flex flex-col">
          ...
          <div className="flex-1 glass-panel rounded-2xl border border-[#1E2748]/15 flex flex-col h-[600px] overflow-hidden">
                      ...
                      <div className="pt-2 flex flex-wrap gap-1.5">
                        {m.suggestedTopics.map((topic, tIdx) => (
                          <button
                            ...
                            className="px-2.5 py-1 bg-[#EBE4CD] hover:bg-[#EBE4CD] text-amber-300 rounded-lg text-[10px] font-semibold transition border border-rose-700/50 flex items-center space-x-1"
                          >
                            <span>{topic}</span>
            ...
            {/* Input Bar */}
            <form onSubmit={(e) => { e.preventDefault(); handleSendMessage(); }} className="p-3 border-t border-[#1E2748]/15 bg-[#F6F2E3] text-[#1E2748] flex items-center space-x-2">
              <input
                type="text"
                value={inputMessage}
              ...
              <button
                ...
                className="px-4 py-3 bg-[#EBE4CD] hover:bg-[#141C33] text-white font-bold rounded-xl shadow-lg transition flex items-center justify-center space-x-1 disabled:opacity-50 border border-[#1E2748]/15"
              >
